...
sub Generate_Fake_Logs_Files
{
    ...
    foreach my $i (0 .. 59)
    {
        ...
        system
            "touch $DIR_LOGS/$DEVICE/Incoming/2010/01/01/msg_00h${minute}.log";
        my $data = '';
        foreach my $i2 (0 .. 19) { $data .= sprintf "line %02d\n", $i2; }
        if (
            defined open my $FILE,
            '|-',
...
cmp_ok(scalar @files_ymdhm,
    '==', 30, 'Octopussy::Logs::Files_Year_Month_Day_Hour_Min()');
