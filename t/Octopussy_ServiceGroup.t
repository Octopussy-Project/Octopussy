...
ok( ( ( !defined $error1 ) && ( defined $error2 ) ),
    'Octopussy::ServiceGroup::Add()' );
...
ok( scalar @SERVICES_KERNEL == scalar @services,
    'Octopussy::ServiceGroup::Services()' );

my $service_added =
  Octopussy::ServiceGroup::Add_Service( $SG_ID, $SERVICE_TO_ADD );
ok( $service_added eq $SERVICE_TO_ADD,
    'Octopussy::ServiceGroup::Add_Service()' );

my $rank =
  Octopussy::ServiceGroup::Move_Service( $SG_ID, $service_added, 'up' );
...
ok( scalar @services == scalar @services2,
